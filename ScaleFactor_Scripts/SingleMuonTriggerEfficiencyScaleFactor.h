...
float AnaScript::TriggEff2016preVFPData_IsoMu24(int id, float pt, float eta)
{
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                  2016postVFP                                  *
 *********************************************************************************/
float AnaScript::TriggEff2016postVFPMC_IsoMu24( float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
...
float AnaScript::TriggEff2016postVFPData_IsoMu24(int id, float pt, float eta)
{
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
...
float AnaScript::TriggEff2017Data_IsoMu27(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
...
float AnaScript::TriggEff2018Data_IsoMu24(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                    2022                                       *  
 *********************************************************************************/
float AnaScript::TriggEff2022Data_IsoMu24(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                    2022EE                                     *  
 *********************************************************************************/
float AnaScript::TriggEff2022EEData_IsoMu24(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                      2023                                     *  
 *********************************************************************************/
float AnaScript::TriggEff2023Data_IsoMu24(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
 ...
 *                                  2023BPix                                     *  
 *********************************************************************************/
float AnaScript::TriggEff2023BPixData_IsoMu24(int id, float pt, float eta){
  if( pt<10 || eta>2.4 ) return 0.0;
  if(fabs(id) == 11) return 0.0;
  float eff = 0.0;
  if(fabs(eta)<=1.479){
