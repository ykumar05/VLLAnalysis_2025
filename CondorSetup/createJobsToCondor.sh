...
MAINDIR=`pwd`
SCRIPTDIR=`pwd`
LOGDIR="/afs/cern.ch/user/y/ykumar/Work/MyAnalysis/AnalyzerCode/CondorSetup/CondorOutput"
CMSDIR="/afs/cern.ch/user/y/ykumar/Work/Arnab_CRAB/AnalysisDatabase/CMSSW_14_0_1/src"
