...
#                                     USER DEFINED                                                  #
##--------------------------------------------------------------------------------------------------#
#jsonfilename ="inputs/sample2023_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2023_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2023BPix_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2023BPix_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2022_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2022_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2022EE_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2022EE_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2018_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2018_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2017_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2017_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2016postVFP_2LSkimmed_EleBitmap.json"
#jsonfilename ="inputs/sample2016postVFP_2LSkimmed_EleBitmap_MisID.json"

#jsonfilename ="inputs/sample2016preVFP_2LSkimmed_EleBitmap.json"
jsonfilename ="inputs/sample2016preVFP_2LSkimmed_EleBitmap_MisID.json"

#2018(3L/4L)
#bkgbundle =["Higgs", "DYJetsToLL", "SingleTop", "TTBar", "TTZ", "TTW", "WZ", "ZZ", "WW", "ZZZ", "WWZ", "WZZ", "WWW", "ZGamma", "Rare"]
#bkgbundle =["Higgs", "TTZ", "TTW", "WZ", "ZZ", "ZZZ", "WWZ", "WZZ", "WWW", "ZGamma", "Rare"]
#bkgbundle =["ZGamma"]
#bkgbundle =["WZ", "ZZ"]
#bkgbundle =["WZ"]
bkgbundle =["ZGamma"]
#bkgbundle =["VLLD_Muon", "VLLD_Electron"]
...
os.system("cp -f "+newjob.anaConddir+"/"+"anaCond_Run3.C "+newjob.codedir)
